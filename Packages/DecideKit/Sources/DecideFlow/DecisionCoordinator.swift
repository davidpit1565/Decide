...
/// A direction DECIDE already has before it finishes — shown so the user gets
...
public final class DecisionCoordinator {
    ...
    public enum Phase: Equatable {
        ...
        case failed(DecideServiceError)
    }
    ...
    /// The user can always decline to answer — DECIDE then continues and says
    ...
    private func performAnalysis() async {
        ...
        do {
            ...
            handle(validated)
        } catch let error as DecideServiceError {
    ...
    private func fail(with error: DecideServiceError) {
    ...
    /// The user's choice, whatever it is. DECIDE does not argue, confirm or persuade.
