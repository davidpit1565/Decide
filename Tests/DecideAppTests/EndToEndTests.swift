...
final class EndToEndTests: XCTestCase {
    ...
    func testALearnedPreferenceReachesTheNextDecision() async throws {
        ...
        // The next decision carries it, so DECIDE does not ask about it again.
...
private final class StubAnalysisService: DecisionAnalysisService, @unchecked Sendable {
    ...
    var failure: DecideServiceError?
    ...
    private func record(_ request: DecisionAnalysisRequest) -> DecideServiceError? {
        lock.lock()
        defer { lock.unlock() }
